<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lista_especialidades.aspx.cs" Inherits="lista_especialidades" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="JPDado Software - Especialidades">
    <meta name="author" content="André Lourenço">
    <title>JPDado Software - Especialidades</title>
    <!-- Favicon -->
    ...
    <div class="main-content">
        ...
        <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
            <div class="container-fluid">
                <!-- Brand -->
                <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">Especialidades</a>
                <!-- Form -->
...
<%--                        <div class="col-xl-3 col-lg-6" id="header3">
                                    ...
                                    <td style="width: 15%; max-width: 15% !important; text-align: right;">
                                        <div id="divCriaNovo">
                                            <a class="btn btn-sm btn-primary" onclick="novo();" style="color: #FFFFFF;">
                                                <span id="spanBtnAlteraStatus"><i class="ni ni-settings" aria-hidden="true"></i>  Criar nova especialidade</span>
                                            </a>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <table style="width:100%; height: auto;">
                                    <tr>
                                        <td style="width: 25%; max-width: 25% !important; text-align: left;">
                                            <div>
                                                <button type='button' style="width:100%; height: 100%;" class='btn btn-sm btn-primary' id='buttonFileUpload' onclick='simulateClickOnFileUploadButton();' runat='server'>Carregar Ficheiro Especialidades</button>
                                            </div>                                        
                                        </td>
                                        ...
                                        <td style="width: 25%; max-width: 25% !important; text-align: center;">
                                            <div>
                                                <asp:Button runat="server" Text="Carregar Especialidades para o Sistema" ID="uploadButton" OnClick="Upload_Click" CssClass="btn btn-sm btn-primary" />
                                            </div>                                        
                                        </td>
    ...
    <script>
        ...
        function getData() {
            loadingOn('A carregar as especialidades. Por favor aguarde...');
            var pesquisa = $('#txtPesquisa').val();
            var order = "";

            if (ordNome == 0 && ordOrdem == 0 && ordTipo == 0 && ordOrdemTipo == 0) {
                order = ' ORDER BY ordem_tipo asc, ordem asc ';
            }
            else {
                order = ' ORDER BY ';
            ...
            $.ajax({
                type: "POST",
                url: "lista_especialidades.aspx/getGrelha",
        ...
        function editar(id) {
            loadUrl('config_ficha_especialidade.aspx?id=' + id);
        }

        function eliminar(id) {
            swal({
                title: 'Eliminar especialidade',
                text: "A especialidade será eliminada. Confirma?",
                type: 'question',
        ...
        function delRow(id) {
            $.ajax({
                type: "POST",
                url: "lista_especialidades.aspx/delRow",
                ...
                success: function (res) {
                    ...
                    if (parseInt(res) <= 0) {
                        sweetAlertWarning("Eliminar especialidade", resMsg);
                    }
                    else {
                        $('#txtPesquisa').val('');
                        ordNome = 0;
        ...
        function novo() {
            loadUrl('config_ficha_especialidade.aspx');
        }
