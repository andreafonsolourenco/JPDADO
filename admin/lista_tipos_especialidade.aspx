<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lista_tipos_especialidade.aspx.cs" Inherits="lista_tipos_especialidade" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="JPDado Software - Tipos de Especialidade">
    <meta name="author" content="André Lourenço">
    <title>JPDado Software - Tipos de Especialidade</title>
    <!-- Favicon -->
    ...
    <div class="main-content">
        ...
        <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
            <div class="container-fluid">
                <!-- Brand -->
                <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">Tipos de Especialidade</a>
                <!-- Form -->
...
<%--                        <div class="col-xl-3 col-lg-6" id="header3">
                                ...
                                <tr>
                                    <td style="width: 50%; max-width: 50% !important;">
                                        <div style="float:left">
                                            <h3 class="mb-0">Tipos de Especialidade</h3>
                                        </div>
                                    </td>
                                    ...
                                    <td style="width: 15%; max-width: 15% !important; text-align: right;">
                                        <div id="divCriaNovo">
                                            <a class="btn btn-sm btn-primary" onclick="novo();" style="color: #FFFFFF;">
                                                <span id="spanBtnAlteraStatus"><i class="ni ni-collection" aria-hidden="true"></i>  Criar novo tipo de especialidade</span>
                                            </a>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <table style="width:100%; height: auto;">
                                    <tr>
                                        <td style="width: 25%; max-width: 25% !important; text-align: left;">
                                            <div>
                                                <button type='button' style="width:100%; height: 100%;" class='btn btn-sm btn-primary' id='buttonFileUpload' onclick='simulateClickOnFileUploadButton();' runat='server'>Carregar Ficheiro Tipos de Especialidade</button>
                                            </div>                                        
                                        </td>
                                        ...
                                        <td style="width: 25%; max-width: 25% !important; text-align: center;">
                                            <div>
                                                <asp:Button runat="server" Text="Carregar Tipos de Especialidade para o Sistema" ID="uploadButton" OnClick="Upload_Click" CssClass="btn btn-sm btn-primary" />
                                            </div>                                        
                                        </td>
    ...
    <script>
        ...
        function getData() {
            loadingOn('A carregar os tipos de especialidade. Por favor aguarde...');
            var pesquisa = $('#txtPesquisa').val();
            var order = "";

            if (ordNome == 0 && ordOrdem == 0) {
                ...
                if (ordNome != 0) {
                    ...
                    order += ordOrdem == -1 ? ' ordem desc ' : ' ordem asc ';
                }
            }

            $.ajax({
                type: "POST",
                url: "lista_tipos_especialidade.aspx/getGrelha",
        ...
        function editar(id) {
            loadUrl('config_ficha_tipos_especialidade.aspx?id=' + id);
        }

        function eliminar(id) {
            swal({
                title: 'Eliminar tipo de especialidade',
                text: "O texto será eliminado. Confirma?",
                type: 'question',
        ...
        function delRow(id) {
            $.ajax({
                type: "POST",
                url: "lista_tipos_especialidade.aspx/delRow",
                ...
                success: function (res) {
                    ...
                    if (parseInt(res) <= 0) {
                        sweetAlertWarning("Eliminar tipo de especialidade", resMsg);
                    }
                    else {
                        $('#txtPesquisa').val('');
                        ordNome = 0;
        ...
        function novo() {
            loadUrl('config_ficha_tipos_especialidade.aspx');
        }
