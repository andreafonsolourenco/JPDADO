...
<head>
    ...
    <meta name="description" content="JPDADO Software - Registo de Atividade">
    <meta name="author" content="André Lourenço">
    <title>JPDADO Software - Registo de Atividade</title>
    <!-- Favicon -->
    ...
    <script>
        ...
        function getData() {
            ...
            $.ajax({
                ...
                data: '{"pesquisa":"' + pesquisa + '","order":"' + order + '","initialDate":"' + initialDate + '","finalDate":"' + finalDate + '","idUser":"' + idUser + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (res) {
