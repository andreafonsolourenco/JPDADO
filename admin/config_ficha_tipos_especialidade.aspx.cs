...
public partial class config_ficha_tipos_especialidade : System.Web.UI.Page
{
    string id = "null";
    ...
    [WebMethod]
    public static string saveData(string id, string nome, string nome_en, string nome_fr, string nome_es, string ordem, string idUser)
    {
        ...
        sql = string.Format(@"  DECLARE @idUser int = {0};
                                ...
                                EXECUTE CRIA_EDITA_TIPOS_ESPECIALIDADE @idUser, @id, @nome, @nome_en, @nome_fr, @nome_es, @ordem, @ret OUTPUT, @retMsg OUTPUT
                                SELECT @ret ret, @retMsg retMsg ", idUser, String.IsNullOrEmpty(id) ? "NULL" : id, nome, nome_en, nome_fr, nome_es, ordem);
    ...
    public static string getData(string id)
    {
        ...
        sql = string.Format(@"  DECLARE @id int = {0}
                                ...
                                select
		                            ...
		                            NOME_ES,
		                            ordem
                                from REPORT_ESPECIALIDADES_TIPO(@id, @especialidade)", id);
        DataSet oDs = oDB.GetDataSet(sql, "").oData;
