<%@ Page Language="C#" AutoEventWireup="true" CodeFile="config_ficha_tipos_especialidade.aspx.cs" Inherits="config_ficha_tipos_especialidade" %>
...
<head>
    ...
    <meta name="description" content="JPDado Software - Ficha de Tipos de Especialidade">
    <meta name="author" content="André Lourenço">
    <title>JPDado Software - Ficha de Tipos de Especialidade</title>
    <!-- Favicon -->
            ...
            <div class="container-fluid d-flex align-items-center">
                <div class="row">
                    <div class="col-lg-12 col-md-10">
                        <h1 class="display-2 text-white">Tipos de Especialidade</h1>
                        <p class="text-white mt-0 mb-5">Crie/Edite o Tipo de Especialidade</p>
    ...
    <script>
        ...
        function getData() {
            ...
            if (id != null && id != 'null' && id != '' && id != '0') {
                $.ajax({
                    type: "POST",
                    url: "config_ficha_tipos_especialidade.aspx/getData",
                    data: '{"id":"' + id + '"}',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (res) {
        ...
        function saveData() {
            ...
            if (ordem == '' || ordem == null || ordem == undefined || parseInt(ordem) < 0) {
                sweetAlertWarning('Ordem', 'Por favor indique a ordem do Tipo de Especialidade');
                return;
            }
            ...
            $.ajax({
                type: "POST",
                url: "config_ficha_tipos_especialidade.aspx/saveData",
                data: '{"id":"' + id + '","nome":"' + nome + '","nome_en":"' + nomeEn + '","nome_fr":"' + nomeFr + '","nome_es":"' + nomeEs
                    + '","ordem":"' + ordem + '","idUser":"' + localStorage.loga + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (res) {
                    var dados = res.d.split('<#SEP#>');
                    ...
                    if (parseInt(dados[0]) > 0) {
                        loadUrl('lista_tipos_especialidade.aspx');
                    }
                    else {
