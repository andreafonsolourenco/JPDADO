...
<head>
    ...
    <meta name="description" content="JPDado Software - Login">
    <meta name="author" content="André Lourenço">
    <title>JPDADO - Login</title>
    <!-- Favicon -->
    ...
    <style>
        .bg-gradient-primary {
            background: linear-gradient(87deg, #7DC7A4 0, #4796CA 100%) !important;
        }
...
<body class="bg-default" style="background-color: #43635B!important">
                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-lg-12 col-md-12">
                            ...
                            <p class="text-lead text-white">Bem-vindo à area de administração da JPDado!</p>
                        </div>
                    </div>
                </div>
            </div>
